...
const AdminManageContents = () => {
    ...
    return (
        <>
            ...
            {isOpen &&
                <div className='absolute z-10 w-full h-full bg-black bg-opacity-60 flex items-center justify-center '>
                    <div className='relative w-[700px]  bg-gray-50  rounded-lg py-12 px-4 max-h-[80%] overflow-y-scroll no-scrollbar'>
                        ...
                        <form onSubmit={handleSubmit} className='flex flex-col gap-2'>
                            ...
                            <div className='flex  items-center ml-4'>
                                ...
                                <input className='mt-1 ml-1' type="radio" name="categories" required onChange={handleInputChange} value="Series" checked={newContentData.categories === 'Series'} />
                            </div>

                            <label htmlFor="creator">  Director:</label>
                            <input className='bg-transparent border p-2 rounded' type="text" required name="director" value={newContentData.director} onChange={handleInputChange} />
                            ...
                            <input className='bg-transparent border p-2 rounded' type="date" required name="releaseDate" value={newContentData.releaseDate} onChange={handleInputChange} />
                            <label htmlFor="releaseDate">  Origin Country</label>
                            <input className='bg-transparent border p-2 rounded' type="text" required name="originCountry" value={newContentData.originCountry} onChange={handleInputChange} />                            
