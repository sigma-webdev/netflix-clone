  ...
  return (
    <div className="flex  justify-center items-center bg-netflix-home h-screen bg-no-repeat bg-cover w-full">
      <div className="py-12 px-16 bg-black bg-opacity-80 h-fit">
        ...
        <div className="mb-2">
          <span className="text-gray-400">New to Netflix? </span><span className="text-white">Sign up now</span> 
        </div>
        <div className="mb-2 w-[320px]">
          <span className="text-gray-400">This page is protected by Google reCAPTCHA to ensure you're not a bot. </span><span className="text-blue-600">Learn more.</span> 
        </div>
      </div>
    </div>
  );
